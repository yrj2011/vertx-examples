...
To run the fat jar:
    ...
    java -jar target/http2-fatjar-3.5.4.jar
...
To run the fat jar:
    ...
    java -jar build/libs/http2-fatjar-3.5.4-all.jar
...
To run the fat jar:
    ...
    java -jar target/ruby-fatjar-3.5.4.jar
...
To run the fat jar:
    ...
    java -jar build/libs/ruby-fatjar-3.5.4-all.jar
