...
To run the fat jar:
    ...
    java -jar target/http2-fatjar-3.5.0.Beta1.jar
...
To run the fat jar:
    ...
    java -jar build/libs/http2-fatjar-3.5.0.Beta1-all.jar
...
To run the fat jar:
    ...
    java -jar target/ruby-fatjar-3.5.0.Beta1.jar.jar
...
To run the fat jar:
    ...
    java -jar build/libs/ruby-fatjar-3.5.0.Beta1-all.jar
