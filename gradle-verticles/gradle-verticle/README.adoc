...
To run the fat jar:
    ...
    java -jar build/libs/gradle-verticle-3.5.0.Beta1-fat.jar
...
java -jar build/libs/gradle-verticle-3.5.0.Beta1-fat.jar -instances 8

You can also enable clustering and ha at the command line, e.g.

java -jar build/libs/gradle-verticle-3.5.0.Beta1-fat.jar -cluster

java -jar build/libs/gradle-verticle-3.5.0.Beta1-fat.jar -ha
