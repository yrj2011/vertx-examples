...
```bash
java -cp target/micrometer-metrics-examples-3.5.4-fat.jar io.vertx.example.micrometer.prometheus.Main
```
...
```bash
java -cp target/micrometer-metrics-examples-3.5.4-fat.jar io.vertx.example.micrometer.ometheus.MainWithBoundPrometheus
```
...
```bash
java -cp target/micrometer-metrics-examples-3.5.4-fat.jar io.vertx.example.micrometer.influxdb.Main
```

=== JMX

```bash
java -cp target/micrometer-metrics-examples-3.5.4-fat.jar io.vertx.example.micrometer.jmx.Main
```
