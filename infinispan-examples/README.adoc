...
----
mvn clean package
java -jar target/infinispan-examples-3.5.4-fat.jar run io.vertx.example.infinispan.StatsProducerApp -cluster
java -jar target/infinispan-examples-3.5.4-fat.jar run io.vertx.example.infinispan.StatsConsumerApp -cluster
java -jar target/infinispan-examples-3.5.4-fat.jar run io.vertx.example.infinispan.DisplayStatsApp -cluster
----
