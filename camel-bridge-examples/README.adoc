...
----
java -jar target/camel-bridge-examples-3.5.0.Beta1.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-3.5.0.Beta1.jar run io.vertx.example.camel.rmi.RMIExample
----
