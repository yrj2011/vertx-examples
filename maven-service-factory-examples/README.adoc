...
[source]
----
vertx run maven:io.vertx:maven-service-factory-verticle:3.5.4::my-verticle
----
...
----
vertx.deployVerticle("maven:io.vertx:maven-service-factory-verticle:3.5.4::my-verticle", r -> { ... });
----
...
mvn clean package
vertx run io.vertx.examples.MyDeployingVerticle -cp target/maven-service-factory-api-3.5.4.jar
----
