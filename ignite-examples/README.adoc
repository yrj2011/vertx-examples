...
----
mvn clean package
java -jar target/ignite-examples-3.5.0.Beta1-fat.jar run io.vertx.example.ignite.ProducerApp -cluster
java -jar target/ignite-examples-3.5.0.Beta1-fat.jar run io.vertx.example.ignite.ConsumerApp -cluster
----
