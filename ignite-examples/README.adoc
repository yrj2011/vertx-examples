...
----
mvn clean package
java -jar target/ignite-examples-3.5.4-fat.jar run io.vertx.example.ignite.ProducerApp -cluster
java -jar target/ignite-examples-3.5.4-fat.jar run io.vertx.example.ignite.ConsumerApp -cluster
----
